...
public class CancionController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 200, message = "Peticón OK")})
    @GetMapping("/{id}")
    public ResponseEntity<Cancion> listarPorId(@PathVariable("id") Integer id){
        Cancion obj = cancionService.leerPorId(id);
        if(obj.getIdCancion() == null) {
            throw new ModeloNotFoundException("ID NO ENCONTRADO " + id);
        }
        return new ResponseEntity<Cancion>(obj, HttpStatus.OK);
    }*/
